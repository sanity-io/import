  ...
  if (missing.length > 1) {
    throw new Error(
      [
        ...
        'Either create these datasets in the given project, or use the `--skip-cross-dataset-references` option to skip these references.',
      ].join('\n'),
    )
  }
  ...
  if (missing.length === 1) {
    throw new Error(
      [
        ...
        'Either create this dataset in the given project, or use the `--skip-cross-dataset-references` option to skip these references.',
      ].join('\n'),
    )
  }
}
